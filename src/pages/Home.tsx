...
export function Home() {
  ...
  function handleAddTask(newTaskTitle: string) {
    ...
    if (duplicateTask) {
      return Alert.alert("Görev zaten kayıtlı", "Aynı ada sahip bir görevi kaydedemezsiniz");
    }
  ...
  const handleRemoveTask = async (id: number) => {
    ...
    Alert.alert('Öğeyi Kaldır', 'Bu öğeyi kaldırmak istediğinizden emin misiniz?', [
      {
        style: 'cancel',
        text: 'Hayır'
      },
